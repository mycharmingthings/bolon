...
gulp.task("copy-html",function () {
    //复制文件
    gulp.src("*.html").pipe(gulp.dest("D:\\phpStudy\\WWW\\bolon"));
});

//把根目录下的所有的js文件复制到发布目录下
gulp.task("copy-js",function () {
    //复制文件
    gulp.src("js/*.js").pipe(gulp.dest("D:\\phpStudy\\WWW\\bolon\\js"));
});

//把PHP文件夹下所有的php文件复制到发布目录下
gulp.task("copy-php",function () {
    //复制文件
    gulp.src("php/*.php").pipe(gulp.dest("D:\\phpStudy\\WWW\\bolon\\php"));
});

//把所有的sql文件复制到发布目录下
gulp.task("copy-sql",function () {
    //复制文件
    gulp.src("*.sql").pipe(gulp.dest("D:\\phpStudy\\WWW\\bolon"));
});
//把所有的txt文件复制到发布目录下
gulp.task("copy-txt",function () {
    //复制文件
    gulp.src("*.txt").pipe(gulp.dest("D:\\phpStudy\\WWW\\bolon"));
});
...
gulp.task("copy-jpg",function () {
    ...
    gulp.src("img/**/*").pipe(gulp.dest("D:\\phpStudy\\WWW\\bolon\\img")); //将文件下所有不管什么格式 png jpg gif都传过去
});
...
gulp.task("sassfile",function () {
    ...
    gulp.src("scss/*.scss").pipe(sass()).pipe(gulp.dest("D:\\phpStudy\\WWW\\bolon\\css"));
});
