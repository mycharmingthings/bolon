...
//     }
//    }))
  .pipe(gulp.dest("F:\\theThirdPary\\MyExpress_bolon\\express_bolon\\src\\public\\javascripts"));
});
...
gulp.task('sass', function () {
    return rubySass('stylesheets/*.scss', {
        sourcemap: false,
        style: 'compressed',
    }).pipe(gulp.dest('F:\\theThirdPary\\MyExpress_bolon\\express_bolon\\src\\public\\stylesheets'));
});
...
gulp.task("copy-html",function () {
    //复制文件
    gulp.src("*.html").pipe(gulp.dest("F:\\theThirdPary\\MyExpress_bolon\\express_bolon\\src\\public"));
});

//把根目录下的所有的js文件复制到发布目录下
gulp.task("copy-js",function () {
    //复制文件
    gulp.src("javascripts/*.js").pipe(gulp.dest("F:\\theThirdPary\\MyExpress_bolon\\express_bolon\\src\\public\\javascripts"));
});
...
gulp.task("copy-sql",function () {
    //复制文件
    gulp.src("*.sql").pipe(gulp.dest("F:\\theThirdPary\\MyExpress_bolon\\express_bolon\\src\\public"));
});
//把所有的txt文件复制到发布目录下
gulp.task("copy-txt",function () {
    //复制文件
    gulp.src("*.txt").pipe(gulp.dest("F:\\theThirdPary\\MyExpress_bolon\\express_bolon\\src\\public"));
});
...
gulp.task("copy-jpg",function () {
    ...
    gulp.src("images/**/*").pipe(gulp.dest("F:\\theThirdPary\\MyExpress_bolon\\express_bolon\\src\\public\\images")); //将文件下所有不管什么格式 png jpg gif都传过去
});
...
gulp.task("copy-css",function () {
    ...
    gulp.src("stylesheets/*.scss").pipe(sass()).pipe(gulp.dest("F:\\theThirdPary\\MyExpress_bolon\\express_bolon\\src\\public\\stylesheets"));
});
...
gulp.task("watchall",function () {
    ...
    gulp.watch("stylesheets/*.scss",["copy-css"]);
